    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="w-[95vw] max-w-[95vw] sm:w-full sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-5xl 
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 flex-1 min-h-0">
            {/* Photo Section */}
            <div className="bg-gray-800 rounded-xl p-4 sm:p-5 lg:p-6 flex-shrink-0">
              <Label className="text-white font-semibold mb-4 block text-sm sm:text-base">
                Member Photo
              </Label>
              <div className="flex flex-col items-center gap-4 sm:gap-6">
                ...
                <div className="flex-shrink-0">
                  <div className="w-28 h-28 sm:w-32 sm:h-32 lg:w-36 lg:h-36 
                                  rounded-full border-4 border-gray-600 
                    ...
                    {getCurrentPhoto() ? (
                      ...
                      <FaUser className="text-3xl sm:text-4xl lg:text-5xl text-gray-500" />
                    )}
                  </div>
                </div>
                ...
                <div className="w-full max-w-sm space-y-4">
                  ...
                  <div className="flex gap-2 justify-center">
                    <Button
                      ...
                      className={`text-sm px-6 py-2 min-w-[80px] ${
                        cameraSide === 'front' 
                  ...
                  <div className="flex flex-col gap-3 w-full">
                    <Button
                      ...
                      className="border-gray-600 text-gray-300 hover:bg-gray-700 
                                text-sm px-4 py-2 h-10 w-full flex items-center justify-center gap-2"
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 flex-1">
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="name" className="text-white font-medium text-sm sm:text-base mb-2 block">
                ...
                <div>
                  <Label htmlFor="phone" className="text-white font-medium text-sm sm:text-base mb-2 block">
                ...
                <div>
                  <Label htmlFor="startDate" className="text-white font-medium text-sm sm:text-base mb-2 block">
                ...
                <div>
                  <Label htmlFor="amountPaid" className="text-white font-medium text-sm sm:text-base mb-2 block">
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="email" className="text-white font-medium text-sm sm:text-base mb-2 block">
                ...
                <div>
                  <Label htmlFor="membershipType" className="text-white font-medium text-sm sm:text-base mb-2 block">
                ...
                <div>
                  <Label htmlFor="endDate" className="text-white font-medium text-sm sm:text-base mb-2 block">
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3 
                           pt-6 border-t border-gray-700 flex-shrink-0">
              <Button
                type="button"
                variant="outline"
                onClick={() => onOpenChange(false)}
                className="border-gray-600 text-gray-300 hover:bg-gray-700 
                          text-base py-3 px-6 h-12 w-full sm:w-auto min-w-[120px]"
              >
                Cancel
              </Button>
              <Button
